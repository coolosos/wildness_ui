...
- **Feat**: Added official `Components` abstract interface and `Configuration.fromComponents` / `WildnessProperties.fromComponents` factory constructors for component builder aggregation.
